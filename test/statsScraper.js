...
describe('statsScraper', function() {
  ...
  describe('getPageContentAndConvertToJson', function() {
    it('should call html to json converter', function(done) {
      ...
      scraper.getPageContentAndConvertToJson(scraper.PLAYER_STATS_URL,
  ...
  describe('getPlayerStatsAsJson', function() {
    it('should display player stats as json', function(done) {
      scraper.getPlayerStatsAsJson(function(err, playerStats) {
        ...
        playerStats[0][scraper.PLAYER_STATS_COLUMNS.playerName].should.exist
        playerStats[0][scraper.PLAYER_STATS_COLUMNS.teamName].should.exist
        playerStats[0][scraper.PLAYER_STATS_COLUMNS.gamesPlayed].should.exist
        playerStats[0][scraper.PLAYER_STATS_COLUMNS.goals].should.exist
        playerStats[0][scraper.PLAYER_STATS_COLUMNS.assists].should.exist
        playerStats[0][scraper.PLAYER_STATS_COLUMNS.penalties].should.exist
        done()
      })
    })
  })
